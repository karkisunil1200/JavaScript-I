...
// let car = Object.keys(inventory[33]);
// console.log(car);
// // for (let i = 0; i < car.length; i++) {
// //   console.log(inventory[33][car[i]]);
// }
console.log(
  `Car 33 is a * ${inventory[33].car_model} * *${inventory[33].car_make}* *${
...
let lastCar = 0;
console.log(
  `${inventory[inventory.length - 1].car_make} is make and model is ${
